...
(0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.subscribe)(function () {
  ...
  const selectedStatus = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/editor').getEditedPostAttribute('status');
  if (vw_publish_guard_enabled && selectedStatus !== statuses[statuses.length - 1].value) {
    if (!postLocked) {
      postLocked = true;
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/editor').lockPostSaving('vip-workflow');
    }
  } else {
    if (postLocked) {
      postLocked = false;
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/editor').unlockPostSaving('vip-workflow');
    }
  }
});
